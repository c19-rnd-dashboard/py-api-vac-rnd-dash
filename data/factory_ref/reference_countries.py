...
countries = (
  ...
  {'name': 'Azerbaijan', 'alpha2': 'AZ', 'alpha3': 'ATE'}, 
  ...
  {'name': 'Cocos (Keeling) Islands', 'alpha2': 'CC', 'alpha3': 'CCX'}, 
  ...
  {'name': 'Denmark', 'alpha2': 'DK', 'alpha3': 'CNK'}, 
  ...
  {'name': 'Saint-Bartelemy', 'alpha2': 'BL', 'alpha3': 'BLM'}, 
  ...
  {'name': 'Serbia and Montenegro', 'alpha2': 'CS', 'alpha3': 'SRB'}, 
  ...
  {'name': 'Virgin Islands, British', 'alpha2': 'VG', 'alpha3': ''}, 
