...
from api.utils.transform import product_contact_transformer
...
class ProductContactTransform(unittest.TestCase):
    ...
    def test_product_contact_transform(self):
        output = product_contact_transformer(self.data)
